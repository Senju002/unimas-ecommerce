...
export default function Edit({ auth, customerData }) {
                ...
                <div className=" mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="bg-white dark:bg-foreground overflow-hidden  sm:rounded-lg shadow-[0_10px_90px_#6F72FF]">
                        <div className="p-6 text-textprimary dark:text-gray-200">
                            <PageHeader
                                description="Form Untuk Mengedit Data Customer"
                                ...
                                <div className="flex gap-4 mobile:flex-col mt-4 tablet:flex-col">
                                    ...
                                    <CustomInput
                                        ...
                                        onChange={(e) =>
                                            setData({
                                                ...data,
                                                urban_village: e.target.value,
                                            })
                                        }
                                        error={errors.urban_village}
                                        message={errors.urban_village}
                                    />
