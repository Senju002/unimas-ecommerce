                ...
                <div className=" mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="bg-white dark:bg-foreground overflow-hidden  sm:rounded-lg shadow-[0_10px_90px_#6F72FF]">
                        <div className="p-6 text-textprimary dark:text-gray-200">
                            <PageHeader
                                description="Informasi Data Produk Gloria Swalayan"
                                title="Data Produk"
                            />
                                                                ...
                                                                <td className="px-6 py-4 text-sm text-gray-100 whitespace-nowrap">
                                                                    {data.image && (
                                                                        <img
                                                                            ...
                                                                            // src={`${window.location.origin}/storage/${data.thumbnail}`}
                                                                            alt={
                                                                                data.image
                                                                            }
                                                                            className="object-cover w-32 h-32 tablet:max-w-[5rem] tablet:max-h-[5rem] rounded-lg "
                                                                        />
                                                                    )}
                                                                </td>
